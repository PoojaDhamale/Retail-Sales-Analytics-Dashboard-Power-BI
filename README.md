...
1. Data Preparation (SQL)<br>

Cleaned and transformed raw data
Converted discount fields into usable numeric format
Created derived metrics such as gross revenue and net sales
<br>
2. Data Analysis (SQL)<br>
